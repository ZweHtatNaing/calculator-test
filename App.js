...
import CalResult from './src/components/cal-result/CalResult';
import BtnContainer from './src/components/cal-btn-container/BtnContainer';
...
class App extends React.Component {
  ...
  /**
    ...
    (First Input Operator(+,-,x,%,) last Input)
   */
  getResult() {
